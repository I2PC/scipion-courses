...
To \textbf{construct 3D atomic models} of biomolecules (typically proteins) based on experimental or predicted data.
...
\begin{tikzpicture}[node distance=1.75cm]
    ...
    \draw [arrow] (mergesym.east) to node[anchor=north] {} ++(0:1) |- (flexiblefit.east);
    ...
    \node(validation_text)[right of=validation, xshift=4cm, yshift=-0.25cm] {\small emringer, validation cryoem (phenix)};
    \node(mergesym_text)[right of=mergesym, xshift=1.9cm] {\small chimera};
